...
from nie.web.routers import watch
...
def create_app() -> FastAPI:
    ...
    (read by the routers to render `templates/`), the watch router
    included, no other wiring yet -- `design.md` §12's full router table is
    added incrementally by later tasks (see issue #34's "Out of scope").
    """
