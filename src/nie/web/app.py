...
from nie.web.routers import context, watch
...
def create_app() -> FastAPI:
    ...
    (read by the routers to render `templates/`), the watch (#34) and
    context (#35) routers included -- `design.md` §12's full router table
    is added incrementally by later tasks.
    """
